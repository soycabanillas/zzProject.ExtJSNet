...
namespace zzProject.ExtJSNet.ExtJS.Classes.Ext.data
{
    ...
    public partial class NodeInterface : zzProject.ExtJSNet.ExtJS.Classes.Ext.Base // NodeInterfaceBase
    {
        //[JsonIgnore]
    ...
    public class NodeInterface<TElement> : NodeInterface //NodeInterfaceBase
    {
        [JsonIgnore]
